 ...
 */
public abstract class StatsMaker implements TelemetrySender {
  ...
  //        new EventConverter(
  //            SetupUtils.buildCommonAttributes(config), config.getThreadNamePattern()));
  //
  ...
  //    System.out.println("Monthly metrics data (GB): " + 30 * 24 * metricSize / (lengthHours *
  // 1024));
  //    System.out.println();
  //
  ...
  //    System.out.println("Monthly events data (GB): " + 30 * 24 * eventSize / (lengthHours *
  // 1024));
  //  }
  //
  //  /**
